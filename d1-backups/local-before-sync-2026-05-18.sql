...
INSERT INTO "profile" VALUES('main','Beyond the Answer.','Sihyeon Ham, 함시현','UI/UX 디자이너, 기획자','<p>안녕하세요,</p><p><em>UI/UX 디자이너, 기획자 </em><strong>함시현</strong><em>입니다.</em></p><p style="margin-top: .5em;">주어진&nbsp;답에 머물지&nbsp;않고, <br />더&nbsp;나은&nbsp;방향을 계속해서 설계합니다.</p>','초등학교 방과 후 교실에서 포토샵에 흥미를 가진 이후, 2014년부터 계속 활동하고 있습니다.',NULL,'[{"label":"hampenta@icloud.com","url":"mailto:hampenta@icloud.com"},{"label":"010 2672 1912","url":"tel:010-2672-1912"},{"label":"서울특별시, 강서구","url":"#profile"},{"label":"test1","url":"mailto:hampenta@icloud.com"}]','2026-05-14 09:09:56');
...
INSERT INTO "works" VALUES('work-01','rush-hour-app','Rush Hour App UI 기획 및 디자인','UI/UX','출퇴근 시간대 이동 경험을 더 빠르게 판단할 수 있도록 설계한 앱 UI 프로젝트.','개인 프로젝트','2023','Figma + Adobe Illustrator','d101cdd0-8559-48e7-8e73-bc0447b15156','d7e4b362-3d71-4a0d-a000-cba279ec85df',1,1,1,'2026-05-07 02:30:48','2026-05-11 13:04:51',NULL);
INSERT INTO "works" VALUES('work-02','orbit-brand','Orbit Brand','BI/BX','유연한 궤도와 선명한 기준을 가진 브랜드 아이덴티티 시스템.','Concept','2025','Brand Identity','4a7f901d-788b-4131-bbd8-69b86dd07c1a',NULL,1,1,2,'2026-05-07 02:30:48','2026-05-13 12:27:01','e05a0cdf-dfbc-4165-aeb4-ff5c0d1fcdd7');
INSERT INTO "works" VALUES('work-03','daily-commerce','Daily Commerce','UI/UX','반복 구매 여정을 짧고 명확하게 만든 커머스 앱 리디자인.','Selected Client','2025','Product Design',NULL,NULL,0,1,3,'2026-05-07 02:30:48','2026-05-13 12:19:54',NULL);
INSERT INTO "works" VALUES('work-04','north-archive','North Archive','BI/BX','아카이브형 브랜드의 콘텐츠 구조와 시각 시스템 설계.','Selected Client','2024','BX Design',NULL,NULL,0,1,4,'2026-05-07 02:30:48','2026-05-13 12:19:49',NULL);
INSERT INTO "works" VALUES('work-05','field-dashboard','Field Dashboard','UI/UX','운영 데이터를 빠르게 스캔하고 조치하는 업무형 대시보드.','Selected Client','2024','UX/UI',NULL,NULL,0,1,5,'2026-05-07 02:30:48','2026-05-13 12:19:58',NULL);
INSERT INTO "works" VALUES('work-06','studio-index','Studio Index','BI/BX','스튜디오의 작업 방식을 색, 그리드, 모션 원칙으로 정리한 아이덴티티.','Concept','2023','Identity System',NULL,NULL,0,1,6,'2026-05-07 02:30:48','2026-05-07 02:30:48',NULL);
INSERT INTO "works" VALUES('01d56af4-cf2b-4cc2-8743-54bba71c371d','ktgigaportal','기가지니 OTT 플랫폼','UI/UX',replace('2021년, 군 복무를 하며 만든 토이 프로젝트입니다.\n\n군 내 기가지니 셋톱박스의 경우 유튜브 및 기타 OTT 서비스를 사용할 수 없도록 제한 조치가 걸려있으나\n일부 앱의 취약점을 이용하여 해당 웹 앱으로 이동하여 사용할 수 있도록 처리하였으며, TV의 경우 모델마다\n올바르게 표현되지 못하는 부분이 있어 KT의 기가지니 앱 개발 가이드를 참고하여 개발하였습니다.\n\nYouTube 영상을 받아오기 위해 일부 오픈소스를 사용하였으며 비디오의 경우 원활한 트래픽 처리를 위해\nAWS를 이용하였습니다.\n\n해당 프로젝트의 경우 공개가 어려운 프로젝트로, 목업 이미지를 확인해 주시길 부탁드립니다.','\n',char(10)),'','2021','UI/UX Design, Full-stack Development','35a1acf4-035f-421c-9513-d9427197e099',NULL,1,1,7,'2026-05-14 08:18:07','2026-05-14 08:55:10','1fcd12e3-6d6a-4ed1-9c10-eb70ba11a1d4');
